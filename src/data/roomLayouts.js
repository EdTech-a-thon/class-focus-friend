...
const layouts = {
  ...
  bedroom: {
    ...
    'moon-lamp': [86.5, 39, 7, 3], 'soft-blanket': [57, 26, 21, 3],
    'art-wall': [29, 61, 14], 'comfy-chair': [19, 23, 14], 'toy-basket': [6, 7, 10], 'closet': [2, 25, 17],
  },
  kitchen: {
    'fruit-bowl': [6, 47, 8, 3], 'tea-kettle': [31, 45, 7, 3], 'mixing-bowls': [7, 66, 8, 3],
    'cookie-jar': [17, 66, 7, 3], 'sunny-table': [5, 3, 24], 'wall-clock': [53, 67, 8],
    'herb-garden': [85, 47, 7, 3], 'recipe-board': [40, 66, 9], 'happy-toaster': [18, 47, 9, 3],
    'cake-stand': [13, 31, 8, 3], 'dining-table': [63, 3, 31], 'place-settings': [82, 29, 8, 3],
    'kitchen-utensils': [28, 57, 9], 'dinner-feast': [69, 29, 10, 3],
  },
  bathroom: {
    ...
    'wash-basket': [3, 7, 11], 'shower-curtain': [70, 49, 27], 'rubber-duck': [79, 39, 5, 3],
